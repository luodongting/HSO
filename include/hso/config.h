...
#ifndef HSO_CONFIG_H_
#define HSO_CONFIG_H_
...
/// Global configuration file of HSO.
...
public:
  ...
  static size_t& maxDropKeyframe() { return getInstance().n_max_drop_keyframe; }

  static void setMaxKLTLevel(const size_t& max_level) {  getInstance().klt_max_level = max_level; }
...
private:
  ...
  // Photomatric calibration threshold
  size_t n_max_drop_keyframe;
};
