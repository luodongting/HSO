...
void fast_corner_detect_plain_9(const fast_byte* img, int imgWidth, int imgHeight, int widthStep, short barrier, vector<fast_xy>& corners);

void fast_corner_detect_plain_8(const fast_byte* img, int imgWidth, int imgHeight, int widthStep, short barrier, vector<fast_xy>& corners);

/// plain C++ version of the corner 7
void fast_corner_detect_plain_7(const fast_byte* img, int imgWidth, int imgHeight, int widthStep, short barrier, vector<fast_xy>& corners);

/// plain C++ version of the corner 12
void fast_corner_detect_plain_12(const fast_byte* img, int imgWidth, int imgHeight, int widthStep, short barrier, vector<fast_xy>& corners);
...
void fast_corner_score_8(const fast_byte* img, const int img_stride, const vector<fast_xy>& corners, const int threshold, vector<int>& scores);

/// corner score 7
void fast_corner_score_7(const fast_byte* img, const int img_stride, const vector<fast_xy>& corners, const int threshold, vector<int>& scores);
